  ...
  try {
    ...
    const sendEmailPromises = employees.map(email => {
      const mailOptions = {
        ...
        text: `You have been assigned a new task for the project:${req.body.projectName}. Please review the task details and start working on it at your earliest convenience. You can view and manage this task by logging into our project management tool http://103.119.171.173:8000/#/employee-tasks` // plain text body
      };
