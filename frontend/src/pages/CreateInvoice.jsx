...
const CreateInvoice = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    total: '',
    bankDetails: {
      accountName: 'Gazetinc Technology LLP',
  ...
  const generateNextInvoiceNumber = async () => {
    const oldInvoice = await axios.get(`${import.meta.env.VITE_BASE_URL}api/lastInvoice`)
    const invoice = '0' + (Number(oldInvoice.data) + 1);
    // console.log(invoice);
    setInvoiceNumber(invoice)
    setFormData(prevFormData => ({ ...prevFormData, invoiceNumber: invoice }));
  ...
  //   setFormData(prevFormData => ({ ...prevFormData, invoiceNumber: e.target.value }));
  // };
                ...
                <div className="d-flex  justify-content-between">
                  <div style={{ width: "49%" }}>
                    <div className="p-3 rounded" style={{ backgroundColor: "lavender" }}>
                      ...
                      <textarea className="fw-semibold" style={{ backgroundColor: "lavender", border: "none" }} rows="9" onChange={handleBilledByChange} defaultValue={"Gazetinc Technology LLP \n\n3rd Floor, Rana Tower, Opp: Mahindra Aura, \nNew Palam Vihar, Phase I, Gurugram, Haryana, \nIndia - 122017 \n\nGSTIN: 06AATFG8894M1Z8 \nPAN: AATFG8894M \nEmail:vinay@techninza.in"} />
                    </div>
                  </div>
                          ...
                          <tr>
                            ...
                            <td className="p-0" style={{ backgroundColor: "lavender", border: "none" }}>
                              <textarea
                                ...
                                rows="1"
                                defaultValue={"Gazetinc Technology LLP"}
